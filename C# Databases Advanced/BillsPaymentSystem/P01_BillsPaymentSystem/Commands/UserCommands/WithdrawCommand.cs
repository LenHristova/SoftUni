namespace P01_BillsPaymentSystem.Commands.UserCommands
{
    ...
    {
        public WithdrawCommand(IUserService userService, IMenuFactory menuFactory)
        ...
        public override IMenu Execute(params string[] args)
        {
            ...
            this.userService.TryToWithdraw(paymentMethodType, id, amount);

            var response = $"${amount} was successfully withdrawn from {type} with id {id}.";
