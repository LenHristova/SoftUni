namespace PhotoShare.Client.Core.Commands
{
    ...
    public class ShareAlbumCommand : ICommand
    {
        ...
        public string Execute(string[] data)
        {
            ...
            {
                throw new InvalidOperationException("You can share only your own albums!");
            }
            ...
            if (isUserAddToAlbum)
            {
                throw new ArgumentException($"User {username} is already added to album {albumId}!"); 
            }
            ...
            return $"User {username} added to album {albumTitle} ({role})!";
        }
    }
}
