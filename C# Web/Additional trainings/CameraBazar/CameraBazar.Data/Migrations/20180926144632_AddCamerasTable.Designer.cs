...
{
    [DbContext(typeof(CameraBazarDbContext))]
    [Migration("20180926144632_AddCamerasTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CameraBazar.Data.Models.Camera", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CameraBazar.Data.Models.User", b =>
                {
            ...
            modelBuilder.Entity("CameraBazar.Data.Models.Camera", b =>
                {
                    b.HasOne("CameraBazar.Data.Models.User", "User")
                        .WithMany("Cameras")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CameraBazar.Data.Models.User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
